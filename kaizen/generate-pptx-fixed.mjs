...
// ── SLIDE 04 — FISHBONE DEEP DIVE 1 ──────────────────────
{
  ...
  cats.forEach((c, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x, y: 0.65, w: 4.1, h: 0.75, fill: { color: c.color, transparency: 87 }, line: { color: c.color, width: 0.5, transparency: 40 }, rectRadius: 0.1 });
...
// ── SLIDE 06 — 5W+1H MATRIX ──────────────────────────────
{
  ...
  cells.forEach((c, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x, y, w: 4.1, h: 0.6, fill: { color: c.color, transparency: 92 }, line: { color: c.color, width: 0.4, transparency: 40 }, rectRadius: 0.08 });
...
// ── SLIDE 07 — DMAIC HUB (Interactive) ───────────────────
{
  ...
  stages.forEach((s, i) => {
    ...
    sl.addShape(pptx.ShapeType.ellipse, { x: pos.x, y: pos.y, w: 1.1, h: 1.1, fill: { color: s.color, transparency: 87 }, line: { color: s.color, width: 1.5 } });
  ...
  stages.forEach((s, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x: 7.5, y, w: 0.85, h: 1.0, fill: { color: s.color, transparency: 87 }, line: { color: s.color, width: 0.5, transparency: 50 }, rectRadius: 0.08 });
...
// ── SLIDE 08 — VALUE STREAM MAPPING ──────────────────────
{
  ...
  before.forEach((s, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x: 0.3, y: 2.08 + i * 0.77, w: 0.28, h: 0.65, fill: { color: C.red, transparency: 85 }, line: { color: C.red, width: 0, transparency: 100 }, rectRadius: 0.06 });
  ...
  after.forEach((s, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x: 6.8, y: 2.08 + i * 0.77, w: 0.28, h: 0.65, fill: { color: C.green, transparency: 85 }, line: { color: "000000", width: 0 }, rectRadius: 0.06 });
...
// ── SLIDE 09 — WORKFLOW COMPARISON ───────────────────────
{
  ...
  steps.forEach(([b, a], i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x: 0.3, y, w: 0.32, h: 0.8, fill: { color: C.red, transparency: 87 }, line: { color: "000000", width: 0 }, rectRadius: 0.06 });
    ...
    sl.addShape(pptx.ShapeType.rect, { x: 6.9, y, w: 0.32, h: 0.8, fill: { color: C.green, transparency: 87 }, line: { color: "000000", width: 0 }, rectRadius: 0.06 });
...
transforms.forEach(t => {
  ...
  sl.addShape(pptx.ShapeType.rect, { x: 0.3, y: 0.7, w: 6.15, h: 0.45, fill: { color: C.red, transparency: 92 }, line: { color: C.red, width: 0.5, transparency: 50 }, rectRadius: 0.08 });
  ...
  sl.addShape(pptx.ShapeType.rect, { x: 6.88, y: 0.7, w: 6.15, h: 0.45, fill: { color: t.afterColor, transparency: 92 }, line: { color: t.afterColor, width: 0.5, transparency: 50 }, rectRadius: 0.08 });
...
// ── SLIDE 14 — FEATURE HUB ────────────────────────────────
{
  ...
  features.forEach((f, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x, y, w: 1.1, h: 1.1, fill: { color: f.color, transparency: 87 }, line: { color: "000000", width: 0 }, rectRadius: 0.08 });
...
// ── SLIDE 17 — COPQ ANALYSIS ──────────────────────────────
{
  ...
  cats.forEach((c, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x: 0.3, y: y + 0.42, w: 12.73, h: 0.55, fill: { color: C.red, transparency: 91 }, line: { color: C.red, width: 0.3, transparency: 70 }, rectRadius: 0.06 });
    // Bar after
...
// ── SLIDE 18 — ROI & BENEFITS ─────────────────────────────
{
  ...
  stds.forEach((s, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x: 7.1, y: 2.82 + i * 1.38, w: 1.0, h: 1.2, fill: { color: s.c, transparency: 87 }, line: { color: "000000", width: 0 }, rectRadius: 0.08 });
...
// ── SLIDE 19 — ROADMAP ────────────────────────────────────
{
  ...
  phases.forEach((p, i) => {
    ...
    sl.addShape(pptx.ShapeType.rect, { x, y: 1.42, w: 2.5, h: 0.7, fill: { color: p.color, transparency: 87 }, line: { color: p.color, width: 0.5, transparency: 50 }, rectRadius: 0.08 });
